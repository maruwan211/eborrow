<?php 
    ...
    if (isset($_POST['insert'])) {
        ...
        $sql = $insertdata->insert2($name_equ, $total_equ);
...
<body>
    ...
    <div class="container">
        ...
        <hr>
        <h1 class="mt-5">เพิ่มข้อมูลอุปกรณ์</h1>
        <hr>
        <form action="" method="post">
            <div class="mb-3">
                <label for="name_equ" class="form-label">ชื่ออุปกรณ์</label>
                <input type="text" class="form-control" name="name_equ" required>
            </div>
            <div class="mb-3">
                <label for="total_equ">ยอดคงเหลือ</label>
